  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <PaletteFormNav open={this.state.open} palettes={palettes} handleSubmit={this.handleSubmit}
        ...
        >
         ...
         <Button variant="contained" color="Primary" className={classes.button} disabled={paletteIsFull} onClick={this.addRandomColor}>Random Color</Button>
         </div>
